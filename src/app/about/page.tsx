...
const About: React.FC = () => {
  return (
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12">
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold mb-6 text-rwanda-green">Our Story</h2>
      ...
      <section className="py-16 bg-rwanda-lightYellow/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-rwanda-green">Our Partners</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
            <div className="flex items-center justify-center p-4 bg-white rounded-lg shadow-sm">
              <Image src="/images/partner-1.svg" alt="Rwanda Development Board" width={120} height={48} className="h-12 w-auto" />
            </div>
            <div className="flex items-center justify-center p-4 bg-white rounded-lg shadow-sm">
              <Image src="/images/partner-2.svg" alt="Visit Rwanda" width={120} height={48} className="h-12 w-auto" />
            </div>
            <div className="flex items-center justify-center p-4 bg-white rounded-lg shadow-sm">
              <Image src="/images/partner-3.svg" alt="Rwanda Tours and Travel Association" width={120} height={48} className="h-12 w-auto" />
            </div>
            <div className="flex items-center justify-center p-4 bg-white rounded-lg shadow-sm">
              <Image src="/images/partner-4.svg" alt="Rwanda Hospitality Association" width={120} height={48} className="h-12 w-auto" />
            </div>
            <div className="flex items-center justify-center p-4 bg-white rounded-lg shadow-sm">
              <Image src="/images/partner-5.svg" alt="Rwanda Convention Bureau" width={120} height={48} className="h-12 w-auto" />
            </div>
            <div className="flex items-center justify-center p-4 bg-white rounded-lg shadow-sm">
              <Image src="/images/partner-6.svg" alt="RwandAir" width={120} height={48} className="h-12 w-auto" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-rwanda-green">Meet Our Team</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-16 bg-rwanda-lightBlue/10">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-rwanda-green">Contact Us</h2>
